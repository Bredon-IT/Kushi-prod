...
const Payment: React.FC = () => {
  ...
  if (paymentSuccess) {
    return (
     <div className="bg-pink-100 min-h-screen py-28">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-navy-900 mb-6">
            Secure{' '}
            <span className="bg-gradient-to-r from-peach-600 to-navy-700 bg-clip-text text-transparent">
              Payment
            </span>
          </h1>
            ...
            <div className="bg-white rounded-3xl shadow-2xl border-2 border-peach-200 overflow-hidden">
              ...
              <div className="p-8">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-peach-300 to-navy-700 text-white py-4 rounded-xl text-lg font-bold hover:from-peach-700 hover:to-navy-800 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-8"
                >
                  {isProcessing ? (
                    <>
