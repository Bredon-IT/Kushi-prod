            ...
            <article>
              ...
              <div className="mt-12 p-8 bg-navy-50 rounded-xl border-l-8 border-peach-400 shadow-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/contact" className="bg-gradient-to-r from-peach-400 to-navy-700 text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-all shadow-lg text-center">
                    Get Free Quote
                  </Link>
                  <Link to="/services" className="border-2 border-navy-700 text-navy-700 px-6 py-3 rounded-lg font-semibold hover:bg-navy-700 hover:text-white transition-all text-center">
                    View Services
                  </Link>
                </div>
              </div>
