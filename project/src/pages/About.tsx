          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="w-full max-w-md lg:max-w-lg shadow-2xl rounded-2xl overflow-hidden aspect-square">
                {/* The image size is controlled by the parent div's max-width 
                  (lg:max-w-lg) and the 'aspect-square' class, preventing it 
                  from consuming the entire viewport height. 
                */}
                <img
