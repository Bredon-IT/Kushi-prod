...
function DescriptionWithToggle({ text }: { text: string }) {
  ...
  const MAX_LENGTH = 100; // show only first 100 characters by default
...
export function Services() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {/* Services Grid (Updated for mobile 2-column layout) */}
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 items-start">
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1">
                  ...
                  <div className="mt-1 text-justify">
                    <DescriptionWithToggle text={service.description} />
                  </div>
