...
const Footer: React.FC = () => {
  ...
  const locationDetails: Record<string, any> = {
    ...
    Hyderabad: {
      phone: "+91 9000000000", // replace with Hyderabad numbers
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Premium cleaning and hygiene services in {location}. Making your space immaculate, safe, and professionally maintained.
            </p>
