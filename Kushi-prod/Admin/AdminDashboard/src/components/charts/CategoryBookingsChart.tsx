...
export function CategoryBookingsChart() {
  ...
  useEffect(() => {
    axios
      .get("https://bmytsqa7b3.ap-south-1.awsapprunner.com/api/customers/all-services")
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bmytsqa7b3.ap-south-1.awsapprunner.com/api/admin/category-bookings", { params })
