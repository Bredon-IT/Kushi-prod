...
await CustomerAPIService.addReward(id);
 ...
 return (
 <div className="font-sans"> {/* Removed space-y-6 here */}
 {/* Search */}
 <div className="relative mb-3"> {/* Added mb-3 for slight separation */}
...
/>
 ...
 {/* Filter Buttons */}
 <div className="flex gap-2 p-2 bg-gray-100 rounded-lg dark:bg-gray-800 mb-3"> {/* Added mb-3 */}
...
className="flex items-center justify-between cursor-pointer"
 ...
 >
<div className="flex items-center space-x-3"> <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
...
<tr className="bg-gray-200 dark:bg-gray-800">
 ...
 >
 <td className="border p-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px]">{b.customer_name}</td>
...
<td className="border p-2">{b.customer_id}</td>
 ...
 <td className="border p-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px]">{b.booking_service_name ?? '-'}</td>
...
<td className="border p-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px]">{b.bookingDate}</td>
